...
const mainMenu = [
    {
        ...
        name: "menu",
        choices: ["View all departments", "View all roles", "View roles by department", "View all employees", "View employees by manager", "View employees by department", "Add a department", "Add a role", "Add an employee", "Update an employee role", "Update an employee manager", "Delete a department", "Delete a role", "Delete an employee"]
    }
]
