...
const { viewEmployees, promptEmployee, getEmployeeList, getManagerList, getManagerID, addEmployee, employeeTable, employeeRolePrompt, updateEmployeeRole, employeeRequest, updateManagerID, managerParams, managerRequest } = require('./employee.js');
