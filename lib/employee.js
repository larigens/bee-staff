  ...
  return new Promise((resolve, reject) => {
    ...
    database
      ...
      .then(([rows]) => {
        ...
        let employeeFullNameList = rows.map(
...
const getManagerList = () => {
  return new Promise((resolve, reject) => {
    ...
    database
      .promise()
      .query(
        `SELECT CONCAT_WS(' ',first_name, last_name) AS Manager FROM employee WHERE manager_id = id;`
      )
      .then(([rows]) => {
...
const getManagerID = (manager) => {
  return new Promise((resolve, reject) => {
    ...
    database
      .promise()
      .query(
        `SELECT manager_id FROM employee WHERE CONCAT_WS(' ',first_name, last_name) LIKE ?;`,
        [manager]
      )
      .then(([rows]) => {
